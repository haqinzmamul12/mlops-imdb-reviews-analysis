...
class Evaluater:
    def __init__(self):
        ...
        self.MODEL_CANDIDATES = {
            ...
            {"C": [0.01, 0.1, 1, 10], "penalty": ["l2"], "solver": ["liblinear", "saga"]}
            ),
    ...
    def evaluate_and_experiment(self):
        try:
            ...
            X, y =df_cleaned.drop(columns=['sentiment'], axis =1), df_cleaned['sentiment']
            ...
            for model_name, (model, model_dist) in self.MODEL_CANDIDATES.items():
                with mlflow.start_run(run_name=model_name) as run:
                    ...
                    mlflow.log_metrics({"accuracy":acc, "precision":prec, "recall":rec, "f1-score":f1})
            ...
            print(f"✅ Approved model: Version {approved_model.version}, Stage: {approved_model.current_stage}")           
